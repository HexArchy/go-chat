...
func (c *chatServiceClient) Connect(ctx context.Context, in *WebSocketRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ChatEvent], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ChatService_ServiceDesc.Streams[0], ChatService_Connect_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[WebSocketRequest, ChatEvent]{ClientStream: stream}
...
func _ChatService_Connect_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ChatServiceServer).Connect(m, &grpc.GenericServerStream[WebSocketRequest, ChatEvent]{ServerStream: stream})
}
...
var ChatService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/api/proto/chat/chat.proto",
}
