...
/*
RegisterUserCreated User successfully registered
...
func (o *RegisterUserCreated) WithPayload(payload *models.AuthenticatedUserResponse) *RegisterUserCreated {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the register user created response
func (o *RegisterUserCreated) SetPayload(payload *models.AuthenticatedUserResponse) {
	o.Payload = payload
}
